...
* if you indend to higlight the content, do so inside your renderer function. Use RegExp object that is passed as a second parameter to that funciton at the runtime. 
