...
* if you indend to highlight the content, do so inside your renderer function. Use RegExp object that is passed as a second parameter to that function at the runtime. 
